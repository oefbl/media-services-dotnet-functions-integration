            ...
            case "MES":
                {
                    ...
                    //taskEncoding = job.Tasks.AddNew("Azure Functions: Media Standard encoding task", processor, "Content Adaptive Multiple Bitrate MP4", TaskOptions.None);
                    //taskEncoding = job.Tasks.AddNew("Azure Functions: Media Standard encoding task", processor, "Summarization", TaskOptions.None);
            ...
            case "MEPW":
                {
                    ...
                    //taskEncoding = job.Tasks.AddNew("Azure Functions: Media Premium Workflow encoding task", processor, "Content Adaptive Multiple Bitrate MP4", TaskOptions.None);
                    //taskEncoding = job.Tasks.AddNew("Azure Functions: Media Premium Workflow encoding task", processor, "Summarization", TaskOptions.None);
